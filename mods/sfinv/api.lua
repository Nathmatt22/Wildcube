...
function sfinv.get_nav_fs(player, context, nav, current_idx)
	...
	if #nav > 1 then
		return "tabheader[1,0.3;sfinv_nav_tabs;" .. table.concat(nav, ",") ..
...
local theme_inv = [[
		...
		background[-1.5,-1.2;12.5,12.5;inventory_bg.png]
		image[0,5.2;1,1;slots.png]
		image[1,5.2;1,1;slots.png]
		image[2,5.2;1,1;slots.png]
		image[3,5.2;1,1;slots.png]
		image[4,5.2;1,1;slots.png]
		image[5,5.2;1,1;slots.png]
		image[6,5.2;1,1;slots.png]
		image[7,5.2;1,1;slots.png]
