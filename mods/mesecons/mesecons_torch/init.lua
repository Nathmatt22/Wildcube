...
minetest.register_node("mesecons_torch:mesecon_torch_off", {
	...
	inventory_image = "jeija_torches_off_inv.png",
	wield_image = "jeija_torches_off_inv.png",
	paramtype = "light",
...
minetest.register_node("mesecons_torch:mesecon_torch_on", {
	...
	use_texture_alpha = "clip",
	inventory_image = "jeija_torches_on_inv.png",
	wield_image = "jeija_torches_on_inv.png",
	paramtype = "light",
	is_ground_content = false,
